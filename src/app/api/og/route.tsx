      ...
      (
        <div
          style={{
            ...
            backgroundImage:
              'radial-gradient(circle at 50% 0%, rgba(16, 185, 129, 0.2) 0%, transparent 60%), radial-gradient(circle at 100% 100%, rgba(56, 189, 248, 0.15) 0%, transparent 50%)',
            padding: '48px 56px',
            color: '#ffffff',
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ fontSize: '24px', fontWeight: 800, letterSpacing: '2px' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', maxWidth: '650px' }}>
              ...
              >
                {isDecoded ? '무의식 행동 진단 결과' : '200개 문항 기반 실시간 텔레메트리 검사'}
              </div>
              <div
                style={{
                  fontSize: '84px',
          ...
          >
            <span>마우스 궤적 및 고민 시간 기반 무의식 MBTI 분석</span>
            <span style={{ color: '#a1a1aa', fontWeight: 600 }}>mbti.opentoyapp.kr</span>
          </div>
        </div>
      ),
      {
